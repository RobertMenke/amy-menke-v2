...
export function Pricing({ ref }: Props) {
    return (
        <div className="mt-32 mx-8 md:mx-32 mb-4 relative js-pricing-section" ref={ref}>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-end w-full justify-center mt-16">
                <PricingBall title="Walk & Talk" rate="130" duration="hour" className="circle-medium" />
                <PricingBall title="Individual" rate="130" duration="hour" className="circle-large lg:mx-20" />
                <PricingBall title="Couples" rate="160" duration="90 mins" className="circle-medium" />
            </div>
        </div>
    )
}
