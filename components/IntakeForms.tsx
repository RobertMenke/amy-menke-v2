...
export function IntakeForms({ ref }: Props) {
    return (
        <>
...
function DownloadForm(props: DownloadFormProps) {
    return (
        <a
            ...
            href={props.link}
            className={`dl-form w-11/12 m-4 lg:w-80 h-40 lg:h-64 p-4 rounded-md border border-pink-600 flex flex-row lg:flex-col justify-between cursor-pointer hover:bg-pink-600 text-pink-600 hover:text-white ${
                props.className || ''
            }`}
        >
